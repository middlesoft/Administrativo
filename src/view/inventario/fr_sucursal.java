...
public class fr_sucursal extends javax.swing.JInternalFrame {
     ...
     */
    public fr_sucursal() throws SQLException {
        initComponents();
        iniciar();
        centrar();
    }
 ...
 public void centrar(){
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(11, 11, 11)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 111, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void bt_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_cancelarActionPerformed
        try {
            ...
            Logger.getLogger(fr_sucursal.class.getName()).log(Level.SEVERE, null, ex);
        }
