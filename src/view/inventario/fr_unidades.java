...
public class fr_unidades extends javax.swing.JInternalFrame {
     ...
     */
    public fr_unidades() throws SQLException {
        initComponents();
        iniciar();
        centrar();
    }
    ...
    public void insertar() throws SQLException{
        ...
        try{
            ...
            cs = conn.prepareCall("{call insertUnidades(?,?)}");
    ...
    public void eliminar() {
        ...
        try{
            ...
            cs = conn.prepareCall("{call deletUnidades(?)}");
            cs.setString(1, codigo);
            rs = cs.executeQuery();
    ...
    public void buscar(){
        ...
        try{
            ...
            cs = conn.prepareCall("{call findUnidades(?,?,?)}");            
            cs.setString(1, codigo);
            rs = cs.executeQuery();
    ...
    public void imprimir(java.awt.event.ActionEvent evt) {
        ...
        System.out.println("Codigo Unidades: "+codigo);
    ...
    public void startReport(String codigo){
        try{
            ...
            vista.setTitle("Reporte de Unidades");
